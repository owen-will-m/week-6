     ...
     export default class Sprout {
          ...
          constructor(x, y) {
               ...
               this.color = Help.hexToRgb("#0e6b0e");
               this.color['a'] = 250;
               this.frame = 0;
          ...
          blade(frame, rotationFactor, heightFactor, widthFactor, deathFrame) {
               ...
               let sy = this.y;
               let stheta = 0;
               let sheight = this.height * heightFactor;
               // let leaves = 0;
               pop();
               push();
               ...
               for (let i = 0; i < frame; i++) {
                    ...
                    let weight = Math.pow(frame, 2.1) * 7 / (i * i * .5 + frame) / deathFrame * widthFactor * -1 * Math.pow(frame - deathFrame, 3) / 200000;
